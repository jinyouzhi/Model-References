...
def build_tokenizer(args):
    ...
    if args.tokenizer_type == 'BertWordPieceLowerCase':
        ...
        tokenizer = _SentencePieceTokenizer(args.tokenizer_model_file, vocab_extra_ids=args.vocab_extra_ids)
    elif args.tokenizer_type == 'GPTSentencePieceTokenizer':
        assert args.tokenizer_model_file is not None
        tokenizer = _GPTSentencePieceTokenizer(args.tokenizer_model_file)
    elif args.tokenizer_type == 'Llama2Tokenizer':
        assert args.tokenizer_model_file is not None
        tokenizer = _Llama2Tokenizer(args.tokenizer_model_file)
    elif args.tokenizer_type == 'NullTokenizer':
        assert args.vocab_size is not None
        tokenizer = _NullTokenizer(args.vocab_size)
    elif args.tokenizer_type == 'HFTokenizer':
        assert args.tokenizer_model_file is not None
        tokenizer = _HFTokenizer(args.tokenizer_model_file,args.seq_length)
    else:
